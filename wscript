...
def build( bld ):
	...
	Components = ''
	create_app( bld, name='bingwa', uselib = 'BOOST_REGEX ' + USELIB, uselib_local = 'qctool_version_autogenerated gen-tools-lib qcdb appcontext db sqlite3 statfile genfile' )
